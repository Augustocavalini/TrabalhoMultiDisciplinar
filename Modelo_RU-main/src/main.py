...
from model import RestaurantModel, agent_portrayal
...
#     server = MesaVisualization(model_cls, [grid, model_text], "University Restaurant Model", 
...
if __name__ == "__main__":
    ...
    restaurant_model = RestaurantModel(external_grid, desired_day, desired_meal, desired_hour, filtered_df)

    page = SolaraViz(
        restaurant_model,
        SpaceComponent,
        name="University Restaurant Model"
    )
